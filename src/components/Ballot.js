      ...
      <div className="Ballot">
        <Page>
          ...
          <ul>
            ...
            <li>Send <a href="https://venmo.com/amarchant" target="_blank" rel="noopener noreferrer">@alexmarchant</a> $5 on venmo</li>
          </ul>
          <h3>Rules</h3>
          <ul>
          ...
          <label>
            ...
            />
            I sent <a href="https://venmo.com/amarchant" target="_blank" rel="noopener noreferrer">@alexmarchant</a> $5 on venmo (or other means).
          </label>
          <hr />
          <p>
